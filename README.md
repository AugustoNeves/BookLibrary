...
This project includes functional tests to ensure the reliability and correctness of the application. The tests are located in the `backend/tests/BookLibrary.Application.FunctionalTesting` folder. Follow the steps below to run the tests.
...
```sh
cd backend/tests/BookLibrary.Application.FunctionalTesting
```
